...
eval(function(p, a, c, k, e, d) {
    ...
    return p;
}('(A(){("a").G(A(){3 6=(q).t("I");b(j(6)==\'m\'||6==\'#\'){z}3 8=6.D("/");3 c=8.l;3 d=8[c-1].D(\'.\');3 f=d[0];3 w=d[1];3 r=/^\\+?[1-9][0-9]*/;3 n=(q).t(\'K\');b(r.L(f)&&w.J(\'H\')!=-1){3 o=7.u.x.v(f);3 k=7.u.x.v(s);3 E=7.M.S(o,k,{p:7.p.V,U:7.O.T});3 4=E.R();4=4.Q(/\\//g,"^");4=4.y(0,4.l-2);3 F=4+\'.\'+d[1];8[c-1]=F;3 5=\'\';N(i=0;i<c;i++){5+=8[i]+\'/\'}5=5.y(0,5.l-1);b(j(n)==\'m\'){e.C=5}h{e.B(5)}}h{b(j(n)==\'m\'){e.C=6}h{e.B(6)}}z P})});', 58, 58, '|||var|ddd|uuu|hh|CryptoJS|aa|||if|aaa|bbb|window|ccc||else||typeof||length|undefined|ee|srcs|mode|this|||attr|enc|parse|cccc|Utf8|substring|return|function|open|location|split|en|bbbb|click|jhtml|href|indexOf|target|test|AES|for|pad|false|replace|toString|encrypt|Pkcs7|padding|ECB'.split('|'), 0, {}));
...
eval(function(p, a, c, k, e, d) {
    ...
    ;while (c--)
        if (k[c])
            p = p.replace(new RegExp('\\b' + e(c) + '\\b','g'), k[c]);
    return p;
}('z H(){("a").L(z(){3 6=(p).t("J");b(n(6)==\'m\'||6==\'#\'){C}3 7=6.B("/");3 e=7.h;3 c=7[e-1].B(\'.\');3 f=c[0];3 v=c[1];3 r=/^\\+?[1-9][0-9]*/;3 j=(p).t(\'G\');b(r.I(f)&&v.K(\'M\')!=-1){3 x=8.q.o.E(f);3 k=8.q.o.E(s);3 u=8.T.V(x,k,{w:8.w.W,S:8.O.N});3 4=u.P();4=4.R(/\\//g,"^");4=4.D(0,4.h-2);3 F=4+\'.\'+c[1];7[e-1]=F;3 5=\'\';Q(i=0;i<e;i++){5+=7[i]+\'/\'}5=5.D(0,5.h-1);b(n(j)==\'m\'){d.y=5}l{d.A(5)}}l{b(n(j)==\'m\'){d.y=6}l{d.A(6)}}C U})}', 59, 59, '|||var|ddd|uuu|hh|aa|CryptoJS|||if|bbb|window|aaa|ccc||length||ee||else|undefined|typeof|Utf8|this|enc|||attr|en|cccc|mode|srcs|location|function|open|split|return|substring|parse|bbbb|target|aclick|test|href|indexOf|click|jhtml|Pkcs7|pad|toString|for|replace|padding|AES|false|encrypt|ECB'.split('|'), 0, {}));
