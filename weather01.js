...
(function() {
    ...
    function x() {
        var a, b = arguments, c, d = {}, e = function(a, b) {
            ...
            for (d in b)
                ...
                a[d] = c && typeof c === "object" && Object.prototype.toString.call(c) !== "[object Array]" && typeof c.nodeType !== "number" ? e(a[d] || {}, c) : b[d]);
            return a
        };
        b[0] === !0 && (d = b[1],
    ...
    pa.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (fa(a))
                ...
                o = v(g, c) || this[c] || 0,
                c !== "d" && c !== "visibility" && c !== "fill" && (o = parseFloat(o));
            else {
                for (c in a)
                    if (j = !1,
                    d = a[c],
                    ...
                    e !== !1) {
                        ...
                        if (c === "d")
                            ...
                            e || (e = y.createElementNS(Ca, "title"),
                            g.appendChild(e)),
                            e.textContent = d;
                        ...
                        if ((c === "width" || c === "height") && h === "rect" && d < 0)
                            d = 0;
                        this[c] = d;
                        c === "text" ? (d !== this.textStr && delete this.bBox,
                        this.textStr = d,
                        this.added && i.buildText(this)) : j || v(g, c, d)
                    }
            ...
            p(e, function(e, f) {
                ...
                p(l, function(e) {
                    if (e !== "" || l.length === 1) {
                        ...
                        if (e !== " " && (n.appendChild(y.createTextNode(e)),
                        m ? o.dx = 0 : o.x = i,
                        v(n, o),
                        !m && f && (!V && d && D(n, {
                            display: "block"
                        ...
                        k))
                            for (var e = e.replace(/([^\^])-/g, "1- ").split(" "), o = e.length > 1 && j.whiteSpace !== "nowrap", t, s, w = a._clipHeight, u = [], r = q(),  = 1; o && (e.length || u.length); )
                                ...
                                t = a.getBBox(),
                                s = t.width,
                                !V && c.forExport && (s = c.measureSpanWidth(n.firstChild.data, a.styles)),
                                t = s > k,
                                !t || e.length === 1 ? (e = u,
                                u = [],
                                e.length && (++,
                                ...
                                p && v(n, "style", p),
                                b.appendChild(n),
                                s > k && (k = s)))) : (n.removeChild(n.firstChild),
                                u.unshift(e.pop())),
        ...
        color: function(a, b, c) {
            ...
            if (g) {
                ...
                for (m in j)
                    q.push(j[m]);
                q = q.join(",");
                h[q] ? a = h[q].id : (c.id = a = "highcharts-" + ub++,
    ...
    if (!V && !da) {
        Highcharts.VMLElement = R = {
            ...
            attr: function(a, b) {
                ...
                if (fa(a))
                    c = a,
                    o = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c];
                else
                    for (c in a)
                        if (d = a[c],
                        m = !1,
                        ...
                        e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                                ...
                                (f.getElementsByTagName("stroke")[0] || T(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid",
                                this.dashstyle = d,
                                m = !0;
                            else if (c === "fill")
                                if (h === "SPAN")
        ...
        var xb = {
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    var f = a + c, g = b + d, h;
                    !t(e) || !e.r ? f = ua.prototype.symbols.square.apply(0, arguments) : (h = I(e.r, c, d),
    ...
    Qa.prototype = {
        ...
        handleOverflow: function(a, b) {
            ...
            if (n)
                B = (d = d.ticks[i[a + (e ? 1 : -1)]]) && d.label.xy && d.label.xy.x + d.getLabelSides()[e ? 0 : 1],
                i = B,
                e && !h || f && h ? g + k < l && (g = l - k,
                d && g + j > i && (c = !1)) : g + j > m && (g = m - j,
                d && g + k < i && (c = !1)),
                b.x = g;
            return c
        },
        ...
        render: function(a, b, c) {
            ...
            if (i && !isNaN(y))
                ...
                this.isFirst && !this.isLast && !n(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !n(e.showLastLabel, 1) ? Z = !1 : !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && (Z = this.handleOverflow(a, v)),
                r && a % r && (Z = !1),
                Z && !isNaN(v.y) ? (v.opacity = c,
    ...
    yb.prototype = {
        render: function() {
            ...
            else if (o && o.length && (a.svgElem = q = u.path(o).attr(d).add(),
            r))
    ...
    qa.prototype = {
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            f === "between" && (f = 0.5),
            a = h * (a - d) * j + i + h * k + (wa(f) ? j * f * this.pointRange : 0));
            return a
        },
        ...
        setAxisTranslation: function(a) {
            ...
            if (this.isXAxis || h)
                ...
                f = g.pointRangePadding) : p(this.series, function(a) {
        ...
        setTickPositions: function(a) {
            ...
            d.type !== b.linkedParent.options.type && ka(11, 1)) : (b.min = n(b.userMin, d.min, b.dataMin),
            ...
            b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : h && !l && q === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = n(l, ma ? 1 : (b.max - b.min) * q / s(b.len, q)),
            !t(l) && b.len < q && !this.isRadial && !ma && d.startOnTick && d.endOnTick && (o = !0,
            b.tickInterval /= 4));
        ...
        zoom: function(a, b) {
            this.allowZoomOutside || (t(this.dataMin) && a <= this.dataMin && (a = u),
        ...
        render: function() {
            ...
            if (v || h)
                ...
                s && a.min === 0 && (m[-1] || (m[-1] = new Qa(a,-1,null,!0)),
                m[-1].render(-1))),
                H && p(i, function(b, c) {
                    if (c % 2 === 0 && b < a.max)
                        o[b] || (o[b] = new yb(a)),
    ...
    qa.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        a = n(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)),
        a = nb(a, null, mb(a)),
    ...
    qa.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (t(b)) {
            j >= E.second && (i.setMilliseconds(0),
            ...
            j >= E.month && (i[Eb](j >= E.year ? 0 : k * N(i[db]() / k)),
            h = i[eb]());
            j >= E.year && (h -= h % k,
            i[Fb](h));
            if (j === E.week)
            ...
            for (var d = i.getTime(), l = i[db](), m = i[Wa](), q = g ? Pa : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c; )
                e.push(d),
                j === E.year ? d = cb(h + b * k, 0) : j === E.month ? d = cb(h, l + b * k) : !g && (j === E.day || j === E.week) ? d = cb(h, l, m + b * k * (j === E.day ? 1 : 7)) : d += j * k,
                b++;
            e.push(d);
            p(wb(e, function(a) {
    ...
    tb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            i = i.call(h, this);
            h = a.series;
            i === !1 ? this.hide() : (this.isHidden && (Za(d),
    ...
    a.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (i && i.tracker) {
                ...
                e && e.followPointer && !e.isHidden && (d = e.getAnchor([{}], a),
                e.updatePosition({
                    plotX: d[0],
                    plotY: d[1]
                }));
    ...
    if (C.PointerEvent || C.MSPointerEvent) {
        ...
        Va(a.prototype, "setDOMEvents", function(a) {
            ...
            p([[this.chart.container, "PointerDown", "touchstart", "onContainerTouchStart", function(a) {
                ...
                F(a[0], PointerEvent ? a[1].toLowerCase() : "MS" + a[1], function(d) {
                    d = d.originalEvent;
    ...
    zb.prototype = {
        ...
        renderItem: function(a) {
            ...
            a.legendItem = r = d.text(e.labelFormat ? Fa(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, y).css(x(a.visible ? i : j)).attr({
                align: m ? "left" : "right",
                zIndex: 2
            }).add(a.legendGroup),
            (y ? r : a.legendGroup).on("mouseover", function() {
                a.setState("hover");
            ...
            d = r.getBBox();
            B = a.legendItemWidth = e.itemWidth || a.legendItemWidth || g + h + d.width + l + (v ? 20 : 0),
            e = B;
    ...
    fb.prototype = {
        ...
        render: function() {
            ...
            if (f.enabled && !a.credits)
                g = f.href,
                a.credits = c.text(f.text, 0, 0).on("click", function() {
                    if (g)
                        location.href = g
                }).attr({
                ...
                if (this.graphic)
                    ...
                    if (a && i)
                        ...
                        k)
                            ...
                            e.stateMarkerGraphic = k = m.renderer.symbol(l, c - f, d - f, 2 * f, 2 * f).attr(q[a]).add(e.markerGroup),
                            k.currentSymbol = l;
                    if (k)
    ...
    O.prototype = {
        ...
        generatePoints: function() {
            ...
            for (m = 0; m < g; m++)
                i = h + m,
                j ? l[m] = (new f).init(this, [d[m]].concat(ja(e[m]))) : (b[i] ? k = b[i] : a[i] !== u && (b[i] = k = (new f).init(this, a[i], d[m])),
                l[m] = k);
            if (b && (g !== (c = b.length) || j))
                for (m = 0; m < c; m++)
                    if (m === h && !j && (m += g),
        ...
        setStackedPoints: function() {
            if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
                ...
                for (n = 0; n < d; n++) {
                    ...
                    l[o] || (l[o] = {});
                    if (!l[o][p])
                        m[o] && m[o][p] ? (l[o][p] = m[o][p],
                        l[o][p].total = null) : l[o][p] = new Gb(k,k.options.stackLabels,q,p,g,e);
                    o = l[o][p];
                    o.points[this.index] = [o.cum || 0];
                    e === "percent" ? (q = q ? h : i,
                    j && l[q] && l[q][p] ? (q = l[q][p],
                    o.total = q.total = s(q.total, o.total) + M(r) || 0) : o.total = aa(o.total + (M(r) || 0))) : o.total = aa(o.total + (r || 0));
                    o.cum = (o.cum || 0) + (r || 0);
        ...
        getAttribs: function() {
            ...
            b.marker ? (e.radius = e.radius || c.radius + 2,
            e.lineWidth = e.lineWidth || c.lineWidth + 1) : e.color = e.color || ta(e.color || g).brighten(e.brightness).get();
        ...
        setState: function(a) {
            ...
            if (this.state !== a)
                this.state = a,
                e[a] && e[a].enabled === !1 || (a && (b = e[a].lineWidth || b + 1),
                c && !c.dashstyle && (a = {
                    "stroke-width": b
                },
                c.attr(a),
    ...
    ca = ia(O, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                k += l;
                i > a && i > e ? (i = s(a, e),
                k = 2 * e - i) : i < a && i < e && (i = I(a, e),
                k = 2 * e - i);
                k > g && k > e ? (k = s(g, e),
                i = 2 * e - k) : k < g && k < e && (k = I(g, e),
                i = 2 * e - k);
                b.rightContX = j;
                b.rightContY = k
            }
    ...
    ca = ia(O, {
        ...
        translate: function() {
            ...
            p(this.points, function(a) {
                ...
                M(c) < f && f && (c = f,
                r = w(M(r - e) > f ? b - f : e - (d.translate(a.y, 0, 1, 0, 1) <= e ? f : 0)));
                a.barX = o;
                a.pointWidth = g;
                b = M(o) < 0.5;
                p = w(o + p) + j;
        ...
        drawPoints: function() {
            ...
            p(a.points, function(g) {
                ...
                if (h !== u && !isNaN(h) && g.y !== null)
                    f = g.shapeArgs,
                    i ? (Za(i),
                    i[b.pointCount < e ? "animate" : "attr"](x(f))) : g.graphic = d[g.shapeType](f).attr(g.pointAttr[g.selected ? "select" : ""]).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                else if (i)
                    g.graphic = i.destroy()
            })
        },
    ...
    O.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(a.plotX, a.plotY, g)))
            ...
            b[e ? "attr" : "animate"](g)) : (b.align(c, null, d),
            g = b.alignAttr,
            n(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : n(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)));
        if (!a)
            b.attr({
                y: -999
            }),
    ...
    if (L.pie)
        L.pie.prototype.drawDataLabels = function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (K = 0; !x && b[K]; )
                    x = b[K] && b[K].dataLabel && (b[K].dataLabel.getBBox().height || 21),
                    K++;
                for (K = 2; K--; ) {
                    ...
                    for (B = 0; B < G; B++) {
                        ...
                        if (this.options.size === null)
                            u = t.width,
                            z - u < f ? D[3] = s(w(u - z + f), D[3]) : z + u > h - f && (D[1] = s(w(z + u - h + f), D[1])),
                            A - x / 2 < 0 ? D[0] = s(w(-A + x / 2), D[0]) : A + x / 2 > d && (D[2] = s(w(A + x / 2 - d), D[2]))
                    }
                }
                if (za(D) === 0 || this.verifyDataLabelOverflow(D))
                    ...
                    r && g && p(this.points, function(b) {
                        ...
                        if ((t = b.dataLabel) && t._pos)
                            ...
                            z = t.connX,
                            A = t.connY,
                            j = k ? ["M", z + (v[6] === "left" ? 5 : -5), A, "C", z, A, 2 * v[2] - v[4], 2 * v[3] - v[5], v[2], v[3], "L", v[4], v[5]] : ["M", z + (v[6] === "left" ? 5 : -5), A, "L", v[2], v[3], "L", v[4], v[5]],
                            i ? (i.animate({
                                d: j
                            }),
        ...
        L.pie.prototype.verifyDataLabelOverflow = function(a) {
            ...
            b[0] += (a[3] - a[1]) / 2);
            d[1] !== null ? e = s(I(e, b[2] - s(a[0], a[2])), c) : (e = s(I(e, b[2] - a[0] - a[2]), c),
            b[1] += (a[0] - a[2]) / 2);
            e < b[2] ? (b[2] = e,
            this.translate(b),
            p(this.points, function(a) {
